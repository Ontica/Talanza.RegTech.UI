...
export class FAQService {
  ...
  public getFAQs(keywords?: string): Observable<Faq[]> {
    ...
    return this.core.http.get<Faq[]>(path)
                .pipe(
                  catchError((e) => this.core.http.showAndReturn(e, FAQsServiceErr.GET_FAQS_ERR, null))
                );
  }
  ...
  public getFAQ(uid: string): Observable<Faq> {
    ...
    return this.core.http.get<Faq>(path)
                .pipe(
                  catchError((e) => this.core.http.showAndReturn(e, FAQsServiceErr.GET_FAQ_ERR, null))
                );
  }

  public addFAQ(faq: Faq): Observable<any> {

    return this.core.http.post<any>('v1/knowledge-base/faqs', faq)
                .pipe(
                  catchError((e) => this.core.http.showAndReturn(e, FAQsServiceErr.POST_ADDFAQ_ERR, null))
                );
  }

  public updateFAQ(faq: Faq): Observable<any> {

    return this.core.http.put<any>(`v1/knowledge-base/faqs/${faq.uid}`, faq,)
                .pipe(
                  catchError((e) => this.core.http.showAndReturn(e, FAQsServiceErr.PUT_FAQ_ERR, null))
                );
